...
namespace ProgecDo.Migrations
{
    ...
    partial class ProgecDoMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgecDo.BoardMessages.BoardMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ProgecDo.BoardMessages.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgecDo.Projects.ProjectUser", b =>
                {
                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgecDo.ToDos.ToDo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgecDo.ToDos.ToDoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgecDo.BoardMessages.Comment", b =>
                {
                    b.HasOne("ProgecDo.BoardMessages.BoardMessage", "BoardMessage")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ProgecDo.Projects.ProjectUser", b =>
                {
                    b.HasOne("ProgecDo.Projects.Project", "Project")
